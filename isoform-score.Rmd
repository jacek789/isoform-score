...
# saveRDS(transcripts, "saved-r-objects/transcripts.RDS")
transcripts <- readRDS("saved-r-objects/transcripts.RDS")
```
...
ensembl.88 %>%
	...
	tbl_df %>%
	senv(ensembl.cds)
saveRDS(ensembl.cds, "saved-r-objects/ensembl.cds.RDS")
```
```{r read_ensembl3}
ensembl.cds <- readRDS("saved-r-objects/ensembl.cds.RDS")
```
...
```{bash conservation_scoring_canonical_transcripts, eval=F}
...
```{bash conservation_scoring_noncanonical_transcripts, eval=F}
PATH=$PATH:/home/jhajto/programs/
DIR=/home/jhajto/r-projects/isoform-score/data/conservation-scores/
...
# ggsave("canonical-transcripts.png")
...
# ggsave("canonical-transcripts2.png")
```
...
[hg38.phastCons20way.bw](http://hgdownload.cse.ucsc.edu/goldenPath/hg38/phastCons20way/)
```{bash conservation_scoring_canonical_appris, eval=F}
PATH=$PATH:/home/jhajto/programs/
DIR=/home/jhajto/r-projects/isoform-score/data/conservation-scores/
...
```{bash conservation_scoring_noncanonical_appris, eval=F}
PATH=$PATH:/home/jhajto/programs/
DIR=/home/jhajto/r-projects/isoform-score/data/conservation-scores/
...
ggplot(scoring_summary_appris %>% gather("is_canonical_mean", "mean_scoring", noncanonical_mean, canonical_mean)) + 
	geom_histogram(aes(x=mean_scoring, fill=is_canonical_mean))
# ggsave("canonical-appris.png")

ggplot(scoring_summary_appris) + 
	geom_density(aes(x=canonical_mean), fill="red", alpha=0.5, adjust=.1) +
	geom_density(aes(x=noncanonical_mean), fill="blue", alpha=0.5, adjust=.1)
# ggsave("canonical-appris2.png")
```
...
```{r }
# saveRDS(ensembl.88.ucsc, "saved-r-objects/ensembl.ucsc.RDS")
ensembl.ucsc <- readRDS("saved-r-objects/ensembl.ucsc.RDS")
```
...
[hg38.phastCons20way.bw](http://hgdownload.cse.ucsc.edu/goldenPath/hg38/phastCons20way/)
```{bash conservation_scoring_canonical_ucsc, eval=F}
PATH=$PATH:/home/jhajto/programs/
DIR=/home/jhajto/r-projects/isoform-score/data/conservation-scores/
...
```{bash conservation_scoring_noncanonical_ucsc, eval=F}
PATH=$PATH:/home/jhajto/programs/
DIR=/home/jhajto/r-projects/isoform-score/data/conservation-scores/
...
ggplot(scoring_summary_ucsc %>% gather("is_canonical_mean", "mean_scoring", noncanonical_mean, canonical_mean)) +
	geom_histogram(aes(x=mean_scoring, fill=is_canonical_mean))
# ggsave("canonical-ucsc.png")

ggplot(scoring_summary_ucsc) +
	geom_density(aes(x=canonical_mean), fill="red", alpha=0.5, adjust=.1) +
	geom_density(aes(x=noncanonical_mean), fill="blue", alpha=0.5, adjust=.1)
# ggsave("canonical-ucsc2.png")
```
